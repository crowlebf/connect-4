...
class Board
  ...
  def winner? (row, column, opponent)
    flag = false
    winner_x?(row, column, opponent) == 4 ? flag = true : return_counted_to_nil
    winner_y?(row, column, opponent) == 4 ? flag = true : return_counted_to_nil
    winner_incline_diag?(row, column, opponent) == 4 ? flag = true : return_counted_to_nil
    winner_decline_diag?(row, column, opponent) == 4 ? flag = true : return_counted_to_nil
    flag
  end
  ...
  def winner_x?(row, column, opponent)
    ...
    count+= winner_x?(row, column+1, opponent)
    count+= winner_x?(row, column-1, opponent)
    count
  end
  ...
  def winner_incline_diag?(row, column, opponent)
    ...
    count = 1
    @grid[row][column].counted = "counted"
    count+= winner_incline_diag?(row+1, column+1, opponent) if row < 9
    count+= winner_incline_diag?(row-1, column-1, opponent) if row > 0
    count
  end
  ...
  def winner_decline_diag?(row, column, opponent)
    ...
    count = 1
    @grid[row][column].counted = "counted"
    count+= winner_decline_diag?(row-1, column+1, opponent) if row > 0
    count+= winner_decline_diag?(row+1, column-1, opponent) if row < 9
    count
  end
